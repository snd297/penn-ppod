CREATE TABLE `ATTACHMENT` (
  ...
  `PPOD_ENTITY_ID` bigint(20) DEFAULT NULL,
...
CREATE TABLE `DNA_CELL` (
  ...
  `ID` bigint(20) NOT NULL,
  `DNA_ROW_ID` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`ID`),
...
CREATE TABLE `DNA_ROW` (
  `ID` bigint(20) NOT NULL,
  `DNA_ROWS_ID` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`ID`),
...
CREATE TABLE `DNA_SEQUENCE` (
  ...
  `ID` bigint(20) NOT NULL,
  `DNA_SEQUENCES_ID` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`ID`),
...
CREATE TABLE `STANDARD_CELL` (
  ...
  `STANDARD_ROW_ID` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`ID`),
...
CREATE TABLE `STANDARD_STATE` (
  ...
  `ID` bigint(20) NOT NULL,
  `STANDARD_CHARACTER_ID` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`ID`),
