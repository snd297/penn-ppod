		...
		for (final OtuSet otuSet : study.getOtuSets()) {
			...
			for (final StandardMatrix matrix : otuSet
				...
				for (final Otu otu : matrix.getParent().getOtus()) {
					...
					matrixInfo.getRowHeaderVersionsByIdx().put(rowIdx, 1L);
