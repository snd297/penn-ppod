...
public interface IOTUKeyedMapPlus<V extends IChild<?>, P extends IChild<IOTUSet>, OP extends IPair<IOtuChangeCase, V>>
	...
	void setValues(final Map<IOtuChangeCase, V> values);
