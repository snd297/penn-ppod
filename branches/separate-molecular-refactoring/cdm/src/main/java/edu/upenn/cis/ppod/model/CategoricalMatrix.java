...
/**
 * A matrix composed of {@link CategoricalRow}s with {@link Character}-indexed
 * columns.
 * 
 * @author Sam Donnelly
 */
...
public class CategoricalMatrix extends Matrix<CategoricalRow> {
	 ...
	 */
	@Inject
	protected CategoricalMatrix(final OTUsToCategoricalRows otusToRows) {
	...
	@Override
	protected OTUsToCategoricalRows getOTUsToRows() {
		return otusToRows;
	}
	...
	private CategoricalMatrix setOTUsToRows(
			final OTUsToCategoricalRows otusToRows) {
