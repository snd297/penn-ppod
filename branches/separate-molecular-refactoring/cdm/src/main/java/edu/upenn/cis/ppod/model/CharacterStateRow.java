...
public class CharacterStateRow extends PPodEntity implements
	...
	public void accept(final IVisitor visitor) {
		for (final CategoricalCell cell : getCells()) {
			cell.accept(visitor);
		}
	 ...
	 */
	public List<CategoricalCell> clearCells() {
		final List<CategoricalCell> clearedCells = newArrayList(getCells());
	 ...
	 *             bounds for this row
	 */
	public CategoricalCell getCell(@Nonnegative final int pPodCellPosition) {
	...
	private List<CategoricalCell> getCells() {
		return cells;
	}
	...
	public List<CategoricalCell> setCells(
			final List<? extends CategoricalCell> newCells) {
		...
		checkState(
				matrix.getColumnsSize() == newCells.size(),
