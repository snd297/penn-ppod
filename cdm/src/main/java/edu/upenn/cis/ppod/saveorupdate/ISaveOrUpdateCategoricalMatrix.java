 ...
 * @author Sam Donnelly
 */
@ImplementedBy(SaveOrUpdateCategoricalMatrix.class)
public interface ISaveOrUpdateCategoricalMatrix {
	 ...
	 *            sourceMatrix}
	 */
	CharacterStateMatrixInfo saveOrUpdate(CategoricalMatrix dbMatrix,
			CategoricalMatrix sourceMatrix);

	static interface IFactory {
		ISaveOrUpdateCategoricalMatrix create(
